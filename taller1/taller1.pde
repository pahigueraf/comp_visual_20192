...
PImage img, img_escala_gris, img_luma, img_segmentacion_brightness, img_kernel_sharpen, img_kernel_blur, img_deteccion_limite, img_kernel_gaussian_blur;
int pgraphics_original_x, pgraphics_original_y, pgraphics_generado_x, pgraphics_generado_y, hist[], selector = 1;
float k = 1.0/9;
float k2 = 1.0/16;
...
void setup() {
  size(1300,520);
  img = loadImage("ushuaia.jpg");
  hist = histogram(img);
  img_escala_gris = loadImage("ushuaia.jpg");
  img_luma = loadImage("ushuaia.jpg");
